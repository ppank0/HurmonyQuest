...
public class Callback : PageModel
{
    ...
    private async Task<ApplicationUser> AutoProvisionUserAsync(string provider, string providerUserId, IEnumerable<Claim> claims)
    {
        ...
        var addToRoleResult = await _userManager.AddToRoleAsync(user, Roles.Participant);
        if (!addToRoleResult.Succeeded) throw new InvalidOperationException(identityResult.Errors.First().Description);
